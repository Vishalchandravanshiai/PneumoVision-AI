...
git clone https://github.com/Vishalchandravanshiai/PneumoVision-AI.git
...
From the web interface, upload a chest X-ray and view the prediction, confidence score, Grad-CAM heatmap, and downloadable report.
